...
export default function InfoSection() {
  return (
    <div className='w-[100vw] flex flex-col justify-center items-center pt-[54px] relative bg-color1'>
        <h1 className='text-center mb-[92px]'>Advanced Statistics</h1>
        <p className='text-center mb-[92px]' >Track how your links are performing<br></br> across the web with our advanced<br></br> statistics dashboard.</p>
